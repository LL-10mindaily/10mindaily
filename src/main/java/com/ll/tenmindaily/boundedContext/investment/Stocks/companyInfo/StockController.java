...
//        try {
//            symbol = getSymbolWithExchangeInfo(symbol);
//            String companyInfo = stockService.getYahooCompanyInfo(symbol);
...
//        }
//    }
//    //장마다 뒤에 붙는 것이 다름 0미국 , 1 코스피, 2코스닥
//    private String getSymbolWithExchangeInfo(String symbol) {
//        if (Character.isDigit(symbol.charAt(0))) {
//            String exchange = "";
//
//            if (symbol.equals("미국")) {
//                // 거래소 정보를 붙이지 않음
//            } else if (symbol.equals("코스피")) {
//                exchange = ".ks"; // ".ks"를 거래소 정보로 설정
//            } else if (symbol.equals("코스닥")) {
//                exchange = ".kq"; // ".kq"를 거래소 정보로 설정
//            }
//
//            symbol += exchange;
//        }
